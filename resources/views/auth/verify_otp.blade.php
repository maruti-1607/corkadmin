            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Mobile & Email OTP <br/> Verification</h1>
                        <p class="signup-link">Already have an account? <a href="{{ route('login') }}">Log in</a></p>
                        <form class="text-left"  method="POST" action="{{ route('verify.otp') }}">
                            @csrf
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="mobile_otp" name="mobile_otp" type="text" class="form-control @error('mobile_otp') is-invalid @enderror" placeholder="Mobile OTP" value="{{ old('mobile_otp') }}" required autocomplete="mobile_otp" autofocus>
                                    @error('mobile_otp')
