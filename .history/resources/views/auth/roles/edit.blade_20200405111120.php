                    ...
                    <div class="tab-content" id="borderTopContent">
                        @foreach($permissions as $action => $action_permissions)
                            ...
                            <div class="tab-pane fade show {{ $active_action_tab }}" id="tab-{{ $action }}"  role="tabpanel">
                                <span class="btn btn-dark btn-sm" @click="select('{{ $action }}')">{{ trans('general.select_all') }}</span>
                                <span class="btn btn-dark btn-sm" @click="unselect('{{ $action }}')">{{ trans('general.unselect_all') }}</span>
